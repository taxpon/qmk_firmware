...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------|   |------+------+------+------+------+------+------|
   * | META | LCtrl|   `  |   \  | LAlt | LGUI |Space |   |Space | RGUI |   '  |   -  |   =  | DOWN | META |
   * `------------------------------------------------'   `------------------------------------------------'
   */
  [BASE] = LAYOUT( \
    ...
    MO(META), KC_LCTL, KC_GRV, KC_BSLS, KC_LALT, KC_LGUI, KC_SPC, KC_SPC, KC_RGUI, KC_QUOT, KC_MINS, KC_EQL, KC_DOWN, MO(META) \
  ),
   ...
   * |------+------+------+------+------+------+------|   |-------------+------+------+------+------+------|
   * | Del  | Rctrl|  F1  |  F2  | Henk |      |      |   | Left | Down |  Up  |Right |      |      | Enter|
   * |------+------+------+------+------+------+------|   |------|------+------+------+------+------+------|
   * | SYMB | LSft |  F3  |  F4  |  F5  |  F6  |  {   |   |  }   |  F7  |  F8  |  F9  | F10  | F11  | F12  |
   * |------+------+------+------+------+------+------|   |------+------+------+------+------+------+------|
  ...
  [META] = LAYOUT( \
    ...
    _______, _______, KC_F1,   KC_F2,   XXXXXXX, XXXXXXX, XXXXXXX,    KC_LEFT,    KC_F6,   KC_F7,   KC_F8,   KC_UP, KC_F9, _______, \
    _______, _______, KC_F3,   KC_F4,   KC_F5,   KC_F6,   S(KC_LBRC), S(KC_RBRC), KC_F10,   KC_F11,   KC_LEFT,   KC_DOWN,  KC_RIGHT,  KC_F12, \
